...
* [2 设计实现详细说明](#2-设计实现详细说明)
    ...
    * [2.2 设计思路详细描述](#22-设计思路详细描述)
        ...
        * [2.2.3 逻辑实现和使用](#223-逻辑实现和使用)
            ...
            * [2.2.3.2 老师录入课程相关信息](#2232-老师录入课程相关信息)
            * [2.2.3.3 学生录入选题和分组](#2233-学生录入选题和分组)
            * [2.2.3.4 信息检索操作](#2234-信息检索操作)
            * [2.2.3.5 全局信息展示](#2235-全局信息展示)
            * [2.2.3.6 分类信息展示](#2236-分类信息展示)
            * [2.2.3.7 刷新系统](#2237-刷新系统)
            * [2.2.3.8 删除课程档案](#2238-删除课程档案)
