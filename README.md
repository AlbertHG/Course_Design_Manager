...
* [2 设计实现详细说明](#2-设计实现详细说明)
    ...
    * [2.2 设计思路详细描述](#22-设计思路详细描述)
        * [2.2.1 数据库E-R图](#221-数据库er图)
        * [2.2.2 数据库字段定义](#222-数据库字段定义)
        * [2.2.3 逻辑实现和使用](#223-逻辑实现和使用)
            * [2.2.3.1 init.pyw运行文件启动程序](#2231-initpyw运行文件启动程序)
            * [2.2.3.2 调用MainWindow类生成主界面](#2232-调用mainwindow类生成主界面)
            * [2.2.3.3 老师录入课程相关信息](#2233-老师录入课程相关信息)
            * [2.2.3.4 学生录入选题和分组](#2234-学生录入选题和分组)
            * [2.2.3.5 信息检索操作](#2235-信息检索操作)
            * [2.2.3.6 全局信息展示](#2236-全局信息展示)
            * [2.2.3.7 分类信息展示](#2237-分类信息展示)
            * [2.2.3.8 刷新系统](#2238-刷新系统)
            * [2.2.3.9 删除课程档案](#2239-删除课程档案)
    * [2.3 涵盖的知识点](#23-涵盖的知识点)
    * [2.4 代码展示](#24-代码展示)
        * [2.4.1 mainUI.py](#241-mainuipy)
        * [2.4.2 AddMsgUI.py](#242-addmsguipy)
        * [2.4.3 Models.py](#243-modelspy)
        * [2.4.4 MySQLite3Util.py](#244-mysqlite3utilpy)
        * [2.4.5 其他py文件](#245-其他py文件)
* [3 总结](#3-总结)
* [4 备注](#4-备注)
    * [4.1 程序文件](#41-程序文件)
    * [4.2 Qt Designer文件](#42-qt-designer文件)
    * [4.3 其余文件](#43-其余文件)
    * [4.4 平台和依赖](#44-平台和依赖)
